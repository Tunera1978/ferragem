...
// txtIdFerragem.setText(String.valueOf(this.ferragemDAO.getFerragemByMaxId()));
    ...
    private void buscarCliente() {
        ...
        // Cliente u = x.getClienteId(1);
        Cliente u = x.getClienteId(Integer.parseInt(txtIdCliente.getText()));
        ...
        if (u == null) {
            ...
            txtNomeCliente.setText(u.getNome());
            txtMensagem.setText("");
        }
    }
    ...
    private void buscarProduto() {
        ...
        // Cliente u = x.getClienteId(1);
        Produto u = x.getProdutoById(Integer.parseInt(txtIdProduto.getText()));
  ...
  {//GEN-HEADEREND:event_txtObservacaoActionPerformed
    ...
    private void txtIdClienteMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_txtIdClienteMouseExited

    }//GEN-LAST:event_txtIdClienteMouseExited
