...
public class frmAcesso extends javax.swing.JInternalFrame {
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(txtIdAcesso, javax.swing.GroupLayout.PREFERRED_SIZE, 74, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNovoActionPerformed
        ...
        txtIdAcesso.setText(String.valueOf(acessoDAO.getAcessoUltimo()));
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        if (status == (true)) {
            ...
            if (this.acessoDAO.inserir(u) == true) {
                ...
                txtMensagem.setText("Acesso Adicionado com sucesso !");
            ...
            u.setIdacesso(Integer.parseInt(txtIdAcesso.getText()));
            u.setDescricao(txtDescricao.getText());            
    ...
    private void btnCancelarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCancelarActionPerformed
        ...
        estadoInicial();
        txtMensagem.setText("");
        txtMensagem.setText("Acesso não sofreu alteração !");
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        if (u == null) {
            ...
            txtIdAcesso.setText(String.valueOf(u.getIdacesso()));
