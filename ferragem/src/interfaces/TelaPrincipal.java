...
public class TelaPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        menuConsultaCliente.setText("Consultas");
        ...
        menuConsultaCliente.add(jMenuItem4);
        ...
        menuConsultaCliente.add(jMenuItem5);
        ...
        menuConsultaCliente.add(jMenuItem6);

        jMenuItem13.setText("Logs");
        menuConsultaCliente.add(jMenuItem13);
        ...
        menuConsultaCliente.add(jMenuItem1);

        jMenuBar1.add(menuConsultaCliente);
  ...
  {//GEN-HEADEREND:event_MenuTipoEnderecoActionPerformed
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
        // TODO add your handling code here:
        JInternalFrame frmConsultaCliente = new frmConsultaCliente();
        this.DesktopPane.add(frmConsultaCliente);
