...
public class frmCidade extends javax.swing.JInternalFrame {
  ...
  private void initComponents()
  {
    ...
    jLabel13.setText("Cod.Municipio:");

    jLabel14.setText("Cod.Municipio:");

    jLabel15.setText("Estado :");

    jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "AC - Acre\t ", "AL - Alagoas\t\t ", "AP - Amapá", "AM - Amazonas", "BA - Bahia", "CE - Ceará", "DF - Distrito Federal", "ES - Espírito Santo", "GO - Goiás", "MA- Maranhão", "MT - Mato Grosso", "MS - Mato Grosso do Sul", "MG - Minas Gerais", "PA - Pará", "PB - Paraíba", "PR - Paraná", "PE - Pernambuco", "PI - Piauí", "RJ - Rio de Janeiro", "RN - Rio Grande do Norte", "RS - Rio Grande do Sul", "RO - Rondônia", "RR - Roraima ", "SC - Santa Catarina", "SP - São Paulo", "SE - Sergipe\t ", "TO - Tocantins" }));
