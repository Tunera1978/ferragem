...
//
    ...
    {//GEN-HEADEREND:event_btnSalvarActionPerformed
        ...
        if (status == true){
          ...
          cl.setInscricao(txtInscricao.getText());
    ...
    {//GEN-HEADEREND:event_btnBuscarActionPerformed
        ...
        if (u == null) {
            ...
            // tipo radio buttom
            //int tipo = u.getFisicoJuridico();            
            //txtId.setText(String.valueOf( u.getFisicoJuridico()));            
            
            if (u.getFisicoJuridico() == 0 ){
                rbFisico.setSelected(true);
                
            }else if ( u.getFisicoJuridico() == 1){
