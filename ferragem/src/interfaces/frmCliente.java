...
public class frmCliente extends javax.swing.JInternalFrame
{
  ...
  private void preencheTabelaContato() {
        ArrayList<ContatoDAO> contato = new ArrayList<ContatoDAO>();
        contato = this.contato.getContatoById(txtId.getText());
        
        DefaultTableModel tabela = (DefaultTableModel) tbContato.getModel();
        tabela.setNumRows(0);
